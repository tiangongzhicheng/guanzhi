...
public class HttpClientUtil {
    ...
    public String sendHttpsGet(String httpUrl, String auth, String imei, String phone, String mac) throws Exception {
        ...
        log.info("jpush query url {}", httpUrl);
     ...
     * @param httpUrl
     */
    public ByteArrayOutputStream sendHttpGetStream(String httpUrl) {
        // 创建get请求
     ...
     * @throws IOException
     */
    public ByteArrayOutputStream sendHttpIgnoreVerify(String httpUrl) throws IOException {
